...
typedef Stats<int16_t, 10688, COLOR_NB, int(SQUARE_NB) * int(SQUARE_NB)> ButterflyHistory;
...
typedef Stats<int16_t, 10688, PIECE_NB, SQUARE_NB, PIECE_TYPE_NB> CapturePieceToHistory;
